...
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_1
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic __consumer_offsets
echo "================================== KAFKA 02/45 =================================="
...
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_1
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_2
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic __consumer_offsets
echo "================================== KAFKA 09/45 =================================="
...
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_1
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_2
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic BENCHMARK_TOPIC_3
docker exec kafka /usr/bin/kafka-topics --bootstrap-server localhost:9092 --delete --topic __consumer_offsets
echo "================================== KAFKA 13/45 =================================="
